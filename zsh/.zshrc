...
alias webui="cd "/home/maulve/stable-diffusion-webui" && source ./venv/bin/activate && ./webui.sh --opt-sdp-attention --no-half-vae --medvram --upcast-sampling --opt-channelslast --skip-python-version-check"
